...
build:
	reveal-md source/slides.md --theme moon --preprocessor source/pre-hack.js --static docs --static-dirs=source --assets-dir=source --absolute-url https://$(USER).github.io/$(REPO)/
	rm docs/slides.md
